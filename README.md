...
| 사용 기술        | 기술 결정 이유                                                                                                                                                                                                                                                                                                                                 |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `MySQL`          | mongoDB vs MySQL<br><br> mongoDB보다 상대적으로 익숙한 MySQL을 이용하는 것이 원활한 프로젝트 진행이 될 것 같다고 판단했고, 선택글-투표-댓글 / 채팅방-참가자-채팅 등 DB간의 테이블간의 관계를 형성하여 참조 무결성을 유지하고, 지속적인 동기화를 위해 sequelize라는 ORM를 사용하여 관계형 데이터 베이스인 MySQL을 사용하였습니다.               |
...
<details>
<summary> ✒️유저 테스트 피드백(10.06 기준)✒️ </summary>
<br>
...
<details>
<summary> ✏️구글 애널리틱스 데이터(첫날 제외)✏️ </summary>
<br>
